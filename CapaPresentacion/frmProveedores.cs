    ...
    public partial class frmProveedores : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.idProveedor == 0)
            {
                ...
                if (idGenerado != 0)
                {
                    datagridviewData.Rows.Add(new object[] {"",idGenerado,textDocumento.Text,textRazonSocial.Text,textCorreo.Text,textTelefono.Text,
        ...
        private void datagridviewData_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (datagridviewData.Columns[e.ColumnIndex].Name == "btnSeleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    textRazonSocial.Text = datagridviewData.Rows[indice].Cells["RazonSocial"].Value.ToString();
